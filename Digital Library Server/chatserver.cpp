...
void chatserver::processData( std::vector<std::string> vec) {
...
void chatserver::serializeData(input &vector) {
...
void chatserver::studentData(int &taskId, std::vector<std::string> & vec) {

}

void chatserver::adminData(int &taskId,std::vector<std::string> & vec) {
...
void chatserver::split(const std::string &s, char delim, Out result) {
	std::stringstream ss;
	ss.str(s);
	std::string item;
...
std::vector<std::string> chatserver::parseData( std::string st) {
...
template<class input>
void chatserver::sendMessageToClients(input const &text)
{
...
int chatserver::convertStringToInt(std::string &num) {
	try {
